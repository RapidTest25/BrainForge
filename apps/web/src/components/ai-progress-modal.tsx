...
const FLOATING_DOCK_OFFSET = 24;
const FLOATING_DOCK_SIZE = 48;
const FLOATING_STACK_GAP = 12;
const STACKED_FLOATING_BOTTOM = FLOATING_DOCK_OFFSET + FLOATING_DOCK_SIZE + FLOATING_STACK_GAP;
...
export function AIGenerateBubble({
  ...
  return (
    <button
      onClick={onClick}
      className="fixed z-50 flex items-center gap-2.5 px-4 py-3 rounded-2xl shadow-2xl border border-border/50 bg-card/95 backdrop-blur-xl hover:scale-105 transition-all duration-200 group cursor-pointer"
      style={{
        right: FLOATING_DOCK_OFFSET,
        bottom: `var(${FLOATING_BUBBLE_OFFSET_VAR}, ${STACKED_FLOATING_BOTTOM}px)`,
          ...
          style={{
            background: hasError
              ...
              : allDone
                ...
                : `linear-gradient(90deg, ${accentColor} 0%, #a78bfa 50%, ${accentColor} 100%)`,
          }}
        >
                      ...
                      <div className="flex items-center justify-between gap-2">
                        ...
                        {isActive && (
                          <span className="shrink-0 flex gap-0.5">
                            <span
                              className="h-1 w-1 rounded-full animate-[ai-bounce_1.4s_ease-in-out_infinite]"
                              style={{ backgroundColor: accentColor }}
                            />
                            <span
                              className="h-1 w-1 rounded-full animate-[ai-bounce_1.4s_ease-in-out_0.2s_infinite]"
                              style={{ backgroundColor: accentColor }}
                            />
                            <span
                              className="h-1 w-1 rounded-full animate-[ai-bounce_1.4s_ease-in-out_0.4s_infinite]"
                              style={{ backgroundColor: accentColor }}
                            />
                          </span>
                        )}
            ...
            <div className="flex gap-2">
              ...
              {allDone && resultId && onOpenResult && (
                <button
                  ...
                  style={{
                    background: `linear-gradient(135deg, ${accentColor}, #6c5ce7)`,
